...
pygame.display.set_caption("Pong Game do LULU")
...
while True:
    ...
    if(
        ...
        left_paddle_x < ball_x < left_paddle_x + paddle_width and
        abs(ball_y + 10 - left_paddle_y) < BALL_SPEED
    ) or (
        right_paddle_x < ball_x < right_paddle_x + paddle_width and
        abs(ball_y + 10 - right_paddle_y) < BALL_SPEED
    ):
        ball_speed_x = -ball_speed_x
